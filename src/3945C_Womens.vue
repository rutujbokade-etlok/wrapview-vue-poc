        ...
        loadMaterials() {
            return new Promise((resolve, reject) => {
                ...
                const hem = new WrapviewTexturedMaterial(
                    ...
                    {
                        resources: {
                            base: `/${this.name}/textures/T_${this.name}_HEM.png`,
                            diffuse: `/${this.name}/textures/T_${this.name}_HEM.png`,
                            normal: `/${this.name}/textures/N_${this.name}_HEM.png`,
                            alpha: `/${this.name}/textures/A_${this.name}_HEM.png`,
                        },
                        build: {
                            parameters: {
                                base: true,
